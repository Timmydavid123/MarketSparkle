...
router.post('/forgot-password/vendor', extractUserId, authController.forgotPasswordVendor);
router.post('/verify-email-vendor', extractUserId, authController.verifyVendorEmail);
